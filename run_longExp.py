...
parser.add_argument('--model_id', type=str, default='custom', help='model id')
...
parser.add_argument('--wavelet', type=str, default='bior3.5')
...
parser.add_argument('--station_lr', type=float, default=0.001)
parser.add_argument('--station_type', type=str, default='adaptive')
parser.add_argument('--pd_ff', type=int, default=128, help='dimension of fcn')
parser.add_argument('--pd_model', type=int, default=128, help='dimension of model')
parser.add_argument('--pe_layers', type=int, default=2, help='num of encoder layers')


# data loader
parser.add_argument('--data', type=str, default='custom', help='dataset type')
parser.add_argument('--root_path', type=str, default='./datasets/traffic', help='root path of the data file')
...
parser.add_argument('--dec_in', type=int, default=862, help='decoder x kernel')
parser.add_argument('--c_out', type=int, default=862, help='output kernel')
